...
ActiveRecord::Schema[8.1].define(version: 2026_01_31_221532) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.check_constraint "section IN ('active', 'this_month', 'next_month', 'this_year', 'next_year')", name: "section_check"
  end
